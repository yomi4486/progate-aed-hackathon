...
def upgrade():
    ...
    print(f"Data copy to new table 'users' completed. Old table has been automatically deleted.")
...
def downgrade():
    ...
    print(f"Data copied to the original table users. The temporary table users_new has been deleted automatically.")
